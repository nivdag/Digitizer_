 ...
 * @param {string|number[]} [options.color] - Text color (HexColor or DecimalColor)
 ...
 * @param {string|number[]} [options.textBox.style.stroke] - Text Box border color  (HexColor or DecimalColor)
 * @param {number[]} [options.textBox.style.dash] - Text Box border border dash style [number, number]
 * @param {string|number[]} [options.textBox.style.fill] - Text Box border background color (HexColor or DecimalColor)
